...
_DESCRIPTION = """\
    FIRE is made of sentences from ....
"""
...
class FIREConfig(datasets.BuilderConfig):
    """BuilderConfig for FIRE."""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(FIREConfig, self).__init__(**kwargs)


class FIRE(datasets.GeneratorBasedBuilder):
    """FIRE"""
