...
_DESCRIPTION = """\
    SCIERC is made of sentences from news articles, annotated with four entity types (person, organization, location, other) 
...
mapping = {'USED-FOR': 'used for', 'FEATURE-OF': 'feature of', 'HYPONYM-OF': 'hyponym of', 'PART-OF': 'part of', 'COMPARE': 'compare', 'EVALUATE-FOR': 'evaluate for','CONJUNCTION': 'conjunction'}
mapping_types = {'Task': '<task>', 'Method': '<method>', 'Metric': '<metric>', 'Material': '<material>', 'OtherScientificTerm': '<other>', 'Generic': '<generic>'}

class SCIERCConfig(datasets.BuilderConfig):
    """BuilderConfig for SCIERC."""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(SCIERCConfig, self).__init__(**kwargs)
